                    ...
                    <div className={`space-y-6 ${id ? 'pointer-events-none' : ''}`}>
                        <div className='p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6'>
                            <div>
                                ...
                                <p>Describe your vision and let our AI generate a thumbnail for you.</p>
                            </div>
                            <div className='space-y-5'>
                                {/*title input*/}
                                <div className="space-y-2">
                                    <label className="block text-sm font-medium">Title or
                                    Topic</label>
                                    <input type="text" value={title} onChange={(e)=>setTitle
                                    (e.target.value)} maxLength={100} placeholder="e.g., 10
                                    Tips for Better Sleep" className='w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20 text-zinc-100 placeholder:text-zinc-400 focus:outline-none focus:ring-2 focus:ring-pink-500'/>
                                <div className='flex justify-end'>
                                    <span className='text-xs text-zinc-400'>{title.length}/100</span>
                                </div>
                                </div>

                                {/*Aspect ratio and style selectors*/}
                                ...
                                <div className="space-y-2">
                                    ...
                                    Additional Prompts <span className="text-zinc-400
                                    text-xs">(optional)</span>
                                    </label>
