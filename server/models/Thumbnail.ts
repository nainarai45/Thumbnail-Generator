...
export interface IThumbnail extends Document {
    ...
    title: string;
    description?: string;
    style: "Bold & Graphic" | "Clean & Minimal" | "Photo-Centric" | "Text-Heavy" | "Illustrative";
...
const ThumbnailSchema = new mongoose.Schema<IThumbnail>({
    ...
    style: { type: String, required: true , enum: ["Bold & Graphic", "Clean & Minimal", "Photo-Centric", "Text-Heavy", "Illustrative"]},
